...
class ScriptDialogNoGUI extends JDialog implements EnterListener, ScriptListener {

    private ConsoleTextPane console;
    private System2DNoGUI box;

    ScriptDialogNoGUI(System2DNoGUI s2d) {
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                box.getScripter().removeScriptListener(ScriptDialogNoGUI.this);
                dispose();
            }
        });
        p.add(button);
